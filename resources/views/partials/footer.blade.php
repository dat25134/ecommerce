        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="{{ route('products.index') }}?category=truyen-thong" class="hover:text-white transition-colors">Bánh Mì Truyền Thống</a></li>
                    <li><a href="{{ route('products.index') }}?category=dac-biet" class="hover:text-white transition-colors">Bánh Mì Đặc Biệt</a></li>
                    <li><a href="{{ route('products.index') }}?category=nuong" class="hover:text-white transition-colors">Bánh Mì Nướng</a></li>
                    <li><a href="{{ route('products.index') }}?category=chay" class="hover:text-white transition-colors">Bánh Mì Chay</a></li>
                </ul>
            </div>
